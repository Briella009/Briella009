...
TriageBloom explores deterministic and explainable security triage with ATT&CK-aligned detections, incident traceability, pseudonymisation, and analyst-readable outputs.

**Focus:** SOC Automation • Explainable Security • Threat Detection • DFIR • MITRE ATT&CK

[View TriageBloom](https://github.com/Briella009/Triagebloom)
...
BGNexa-AI explores how structured AI-assisted evidence analysis can support security assessments, compliance workflows, control validation and governance decision-making.

**Focus:** AI Governance • GRC • Cybersecurity Assurance • Evidence Intelligence

[View BGNexa-AI](https://github.com/Briella009/BGNexa-AI)

---

### 🏥 ClinDrift

**AI-assisted monitoring of clinical information drift and safety-relevant inconsistencies in digital health systems.**

ClinDrift investigates how changes in clinical information can be identified, structured and assessed to support safer and more trustworthy AI-enabled healthcare systems.

**Focus:** Digital Health • Trustworthy AI • Clinical AI Safety • Information Drift
...
My academic and applied research includes work across:

**Artificial Intelligence • Cybersecurity • Threat Intelligence • Digital Health • IoT Security • AI Governance**

I have presented research internationally, including work involving **Explainable AI and Cyber Threat Intelligence**, while developing additional manuscripts for journal and conference publication.

Research outputs, datasets and reproducible implementations will increasingly be made available through my GitHub repositories.
...
> **Building trustworthy, explainable and secure AI systems for cybersecurity and high-risk digital environments.**
